...
const Sidebar = () => {
    ...
    const navigation = [
        { icon: 'dashboard', label: 'לוח בקרה', path: '/admin/dashboard' },
        { icon: 'point_of_sale', label: 'קופה', path: '/pos/checkout' }, // Added POS
        { icon: 'inventory_2', label: 'מוצרים', path: '/admin/products' },
        { icon: 'account_balance_wallet', label: 'ארנקים', path: '/admin/wallets' },
        { icon: 'group', label: 'משתמשים', path: '/admin/users' },
        // { divider: true }, // Spacer removed to save space
    ];
