...
function App() {
  ...
  return (
    <Router>
      <Toaster position="top-center" reverseOrder={false} containerStyle={{ zIndex: 999999 }} toastOptions={{ className: 'font-sans font-bold shadow-lg rounded-xl text-center', style: { padding: '16px', color: '#166534', backgroundColor: '#ecfdf5', border: '1px solid #a7f3d0' } }} />
      <Routes>
        ...
        <Route element={<DashboardLayout />}>
          ...
          <Route element={<PrivateRoute allowedRoles={['admin']} />}>
            ...
            {/* Legacy redirect */}
            <Route path="/admin" element={<Navigate to={user?.role === 'superadmin' ? '/admin/environments' : '/admin/dashboard'} replace />} />
          </Route>

          {/* Superadmin environment management */}
          <Route element={<PrivateRoute allowedRoles={['superadmin']} />}>
            <Route path="/admin/environments" element={<SuperAdminDashboard />} />
          </Route>

          {/* Shared Admin/Officer/Cashier Routes */}
          <Route element={<PrivateRoute allowedRoles={['admin', 'officer', 'cashier']} />}>
