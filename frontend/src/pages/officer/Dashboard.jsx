                ...
                <main className="flex-1 lg:mr-32 flex flex-col gap-6 h-full overflow-y-auto pr-2 pl-4 py-2">
                    ...
                    <header className="flex justify-between items-end mb-4">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {/* Notifications */}
                            <button className="relative w-12 h-12 rounded-full bg-white dark:bg-sage-600/30 flex items-center justify-center shadow-sm hover:shadow-md transition-shadow group">
                                <span className="material-icons-round text-sage-500 group-hover:text-primary transition-colors">
                                    notifications
                                </span>
                                <span className="absolute top-3 right-3 w-2 h-2 bg-terracotta-500 rounded-full ring-2 ring-white dark:ring-background-dark"></span>
                            </button>
                        </div>
                    </header>
