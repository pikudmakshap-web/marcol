                ...
                <div className="bg-white rounded-[32px] p-8 shadow-[0_4px_20px_rgb(0,0,0,0.04)]">
                    ...
                    <form onSubmit={handleSaveSettings} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={saving}
                            className="w-full bg-[#526f52] hover:bg-[#435c43] text-white disabled:opacity-50 py-3.5 rounded-xl font-bold transition-all flex items-center justify-center gap-2 mt-4"
                        >
